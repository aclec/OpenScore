...
export function CalcKey({ label, onPress, variant = "default", wide, fontSize = 24, fontWeight = "500", a11yLabel }: Props) {
    ...
    return (
        <Pressable
            ...
            className={`h-[50px] items-center justify-center rounded-xl active:opacity-80 ${BG[variant]}`}
